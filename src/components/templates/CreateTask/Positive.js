...
export default class extends React.Component {
	...
	componentDidMount() {
		...
		this.otherBinding = base.syncState(`/users/${userId}/tutorial/showExplanation/positive`, {
			context: this,
	...
	render() {
		return (
			<div>
				...
				<textarea value={this.state.task.diaryEntry} onChange={this.updateEntry} />
				<Modal
				...
				>
					Sam is here to guide your thoughts toward feeling more positive everyday.
					Simply respond to Sam and start feeling the difference! We recommend having
					a reflection at least 21 times everyday to see the best effect.
				</Modal>
			</div>
		)
	}
